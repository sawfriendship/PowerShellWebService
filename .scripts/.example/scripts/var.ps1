...
$vars = Get-Variable -Name $Name | select Name,@{n='Value';e={ConvertTo-Json $_.Value -Depth 2}}
                ...
                <div class="container">
                    <div class="row row-cols-2">
                        <div id="LEFT" class="col-xs-12 col-sm-12 col-md-8 col-lg-4 col-xl-4 col-xxl-4" style="z-index:2">
                            ...
                            <br>
                            $($vars | ConvertTo-Html -Fragment -Property Name,Value | Out-String)
                        </div>
                    </div>
                </div>
            </main>
